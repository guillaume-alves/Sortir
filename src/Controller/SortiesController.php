...
class SortiesController extends AbstractController
{
    ...
    public function creer(
        ...
        ParticipantRepository $participantRepository, //todo: récupér l'organidsateur
        EtatRepository $etatRepository, //todo: créer un objet plutot que d'aller le chercher en bdd
